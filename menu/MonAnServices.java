...
import menu.MonAn.DanhMucMonAn;
import menu.MonAn.LoaiMonAn;
import user.User;
    ...
    public static List<MonAn> timKiemMonAn(Scanner scanner) {
        ...
        while(true){
            ...
            if (luaChon == 1) { 
                ...
                switch (choice) {
                    case 1 -> filterValue = "DO_AN";
                    case 2 -> filterValue = "DO_UONG";
                    default -> {
                ...
                switch (subchoice) {
                    case 1 -> filterValue = "DO_KHO";
                    case 2 -> filterValue = "DO_NUOC";
                    case 3 -> filterValue = "CO_CON";
                    case 4 -> filterValue = "KHONG_CON";
                    default -> {
                        System.out.println("Lỗi! Vui lòng nhập lại.");
                        return danhSach;
                    }
